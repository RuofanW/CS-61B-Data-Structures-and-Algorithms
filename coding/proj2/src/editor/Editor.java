...
public class Editor extends Application {
    ...
    private class KeyEventHandler implements EventHandler<KeyEvent> {
        ...
        //public ArrayList<String> Stringtyped = new ArrayList<String>();
        public String Stringtypedano = new String();
        @Override
        public void handle(KeyEvent keyEvent) {
            ...
            if (keyEvent.getEventType() == KeyEvent.KEY_TYPED) {
                ...
                if (characterTyped.length() > 0 && characterTyped.charAt(0) != 8) {
                    ...
                    Stringtypedano = Stringtypedano + characterTyped;
                }

                displayText.setText(Stringtypedano);
                keyEvent.consume();
                TopLeftText();
                ...
                if (code == KeyCode.UP) {
                    ...
                    int currentlength = Stringtypedano.length();
                    Stringtypedano = Stringtypedano.substring(0, currentlength - 1);
                    displayText.setText(Stringtypedano);
                    keyEvent.consume();
                    TopLeftText();
                }
