...
public class IntList {
    ...
    public static IntList catenate(IntList A, IntList B) {
        ...
        IntList q = p;
        while(s != null){
            q.tail = new IntList(s.head, catenate(s.tail, B) );
            q = q.tail;
            s = s.tail;
        }
    ...
    public static IntList reverse(IntList A){
        ...
        IntList front = A.tail;
        IntList rear = new IntList(A.head, null);
        IntList res = catenate(front, rear);
        while(A != null){
            A = A.tail;
            front = A;
            IntList temp = new IntList(A.head,null);
            IntList currear = rear;
            rear = catenate(temp, currear);
            res = catenate(reverse(front), rear);
        }
